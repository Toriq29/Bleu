...
<body class="center">
    ...
    <table class="table2">
        <tr>
            <td>
                <img src="src/wallett.png">
            </td>
            
            <td class="left">
                <h1 class="font">/Wallet</h1>
                <h1><p class="merah">100k</p></h1>
                <br>
                <h3>The wallet is a compact accessory with a refined look. With multiple<br>
                    card slots and compartments, it’s a practical everyday companion for the<br>
                    modern man with classic tastes.<br><br>
                    <div class="divkanan"><h3 class="top"><li>800 Ulasan</li></h3></div>
                    <div class="divkanan"><h3><li>1.256 Terjual</li></h3></div>
                    <br>
                </h3><br></p><br>
                <form action="struk.php" method="POST" left="60%" target="blank">
		            <input class="button1" type="text" name="jumlah" id="angka" value="0">
                    <input type="hidden" name="nama" value="Wallet">
